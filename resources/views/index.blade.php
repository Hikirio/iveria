            ...
            <div class="collapse navbar-collapse nav-collapse">
                <div class="menu-container">
                    <ul class="navbar-nav navbar-nav-right">
                        <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="{{ url('/home') }}">Home</a>
                        </li>
                        ...
                        <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="{{ url('/about') }}">About</a>
                        </li>
                        <li class="nav-item"><a class="nav-item-child nav-item-hover active"
