...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Iveria-Aqua</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li>
                        <a class="active" href="{{url('/admin')}}"><i class="fa fa-dashboard fa-fw"></i> Главная
                            страница админ панели</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-sitemap fa-fw"></i> About<span
                                    class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{url('admin/oursource')}}">Our Source
                                </a>
                            </li>
                            <li>
                                <a href="{{url('admin/ourproduct')}}">Our Product
                                </a>
                            </li>
                            <li>
                                <a href="{{url('admin/analysis')}}">Our Mineral Analysis
                                </a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
    ...
    <div id="page-wrapper">
                ...
                <div class="panel panel-yellow">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">{{$productions}}</div>
                                <div>Количество продукции</div>
                                {{--                                --}}
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                {{--                Чат модераторов и админов           --}}


                <div class="chat-panel panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-comments fa-fw"></i>
                        Внутренний рабочий чат
