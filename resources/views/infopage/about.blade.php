            ...
            <div class="collapse navbar-collapse nav-collapse">
                <div class="menu-container">
                    <ul class="navbar-nav navbar-nav-right">
                        ...
                        <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="about.html">About</a>
                        </li>
                        <li class="nav-item"><a class="nav-item-child nav-item-hover" href="products.html">Products</a>
                        </li>
            ...
            @foreach($water as $w)
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                        <h3>{{($w->title)}}</h3>
                        <p>{{$w->description}}</p>
                        <a class="link" href="{{url($w->url)}}">Read More</a>
                    </div>
                </div>
            @endforeach
        </div>
        ...
        <div class="col-sm-7 sm-margin-b-50">
            <div class="margin-b-30">
                <p>Lorem ipsum dolor sit amet consectetur adipiscing elit sed tempor incididunt ut laboret dolore
                    adipiscing elit sed tempor incididunt ut laboret dolore magna aliqua. Ut enimet minim veniam magna
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipiscing elit sed tempor incididunt ut laboret tempor incididunt
                ...
                tempor incididunt ut laboret dolore magna aliqua. Ut enim minim veniam exercitation laboris ut siad
